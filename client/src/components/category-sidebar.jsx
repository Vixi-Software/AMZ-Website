...
export default function CategorySidebar() {
  return (
    <div className="bg-white rounded-lg lg:p-4 md:p-2 sticky top-4">
      <p className="font-medium mb-1 text-base">Hàng cũ giá tốt - Sản phẩm chính</p>

      <div className="space-y-4 pl-2">
        {categoryData.map((item, index) => (
          <div key={index} className="flex items-center gap-3 hover:bg-gray-50 p-2 m-0 rounded transition-colors cursor-pointer">
      ...
      <p className="font-medium text-base mb-1">Khám phá thêm</p>
