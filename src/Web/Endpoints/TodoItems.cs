using amz.Application.Common.Models;
using amz.Application.TodoItems.Commands.CreateTodoItem;
using amz.Application.TodoItems.Commands.DeleteTodoItem;
using amz.Application.TodoItems.Commands.UpdateTodoItem;
using amz.Application.TodoItems.Commands.UpdateTodoItemDetail;
using amz.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace amz.Web.Endpoints;
